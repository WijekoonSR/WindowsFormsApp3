    ...
    public partial class PayrollUIEditStaff : UserControl
    {
        ...
        private void btncheck_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String sql2 = "select * from Payroll_Staff where EmployeeID = '" + EmployeeID + "'";
                ...
                try
                {
                    ...
                    using (SqlDataReader read = cmd2.ExecuteReader())
                    {
                        while (read.Read())
                        {
                            ...
                            //edtName.Text = (read["FistName"].ToString());
                            //edtName.Text = "name";
                            //drpMonth =  read.GetValue(2).ToString();
                            edtOT.Text = read.GetValue(3).ToString();
                            edtBasicSalary.Text = read.GetValue(5).ToString();
                            edtHousingAllowance.Text = read.GetValue(6).ToString();
                            edtMedicalAllowance.Text = read.GetValue(7).ToString();
                            edtFoodAllowance.Text = read.GetValue(8).ToString();
                            edtOtherAllowance.Text = read.GetValue(9).ToString();
                            edtSalaryAdvance.Text = read.GetValue(10).ToString();
                            edtETF.Text = read.GetValue(11).ToString();
                            edtEPF.Text = read.GetValue(12).ToString();
                            edtInsurance.Text = read.GetValue(13).ToString();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    String sql = "Update Payroll_Staff SET BasicSalary = '" + BasicSalary + "', HousingAllowance = '" + HousingAllowance + "', MedicalAllowance = '" + MedicalAllowance + "', FoodAllowance = '" + FoodAllowance + "', OtherAllowance = '" + OtherAllowance + "', SalaryAdvance = '" + SalaryAdvance + "',  ETF = '" + ETF + "', EPF = '" + EPF + "', Insurance = '" + Insurance + "'  where EmployeeID = '" + EmployeeID + "'";
